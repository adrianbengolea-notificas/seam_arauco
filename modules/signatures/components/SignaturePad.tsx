...
/**
 * Canvas de firma; exporta PNG data URL (base64) para almacenar en la OT.
 */
export function SignaturePad({ className, width = 320, height = 160, onChange }: Props) {
  ...
  useEffect(() => {
    ...
    ctx.lineWidth = 2;
    ctx.lineCap = "round";
    /** Canvas quedó en blanco (p. ej. cambió tamaño); sincronizar padre sin depender de la identidad de `onChange`. */
