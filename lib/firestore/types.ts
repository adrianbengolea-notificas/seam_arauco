...
export interface ItemRespuesta {
  ...
  comentario?: string;
  /** GG: respuesta por acción individual (clave = label de la acción). */
  accionesRespuestas?: Record<string, { checklist?: boolean; servis?: boolean; observacion?: string }>;
}
...
export interface PlanillaRespuesta {
  ...
  /** Data URL legado; nuevas planillas firmadas dejan esto vacío y usan *DownloadUrl. */
  firmaUsuario?: string;
  firmaUsuarioNombre?: string;
  firmaUsuarioLegajo?: string;
  firmaUsuarioFecha?: Timestamp;
  firmaUsuarioStoragePath?: string;
  firmaUsuarioDownloadUrl?: string;
  firmaResponsable?: string;
  firmaResponsableNombre?: string;
  firmaResponsableStoragePath?: string;
  firmaResponsableDownloadUrl?: string;
...
export interface Notificacion {
  ...
  cuerpo: string;
  leida: boolean;
  /** Ruta interna al hacer clic (p. ej. `/programa/aprobacion?semana=…`). */
  href?: string;
  otId?: string;
  materialId?: string;
  creadoAt: Timestamp;
