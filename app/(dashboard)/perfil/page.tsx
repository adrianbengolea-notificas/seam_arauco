  ...
  return (
    <div className="mx-auto max-w-lg space-y-6 py-2">
      ...
      {profile?.pushHabilitado === undefined ? (
        <PushOptInBanner key={user.uid} variant="comfortable" />
      ) : null}
      ...
      <Card>
        ...
        <CardContent className="space-y-3 text-sm">
          ...
          <div>
            <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Centro(s)</p>
            <p className="mt-0.5 font-mono text-foreground">
              {profile ? centrosEfectivosDelUsuario(profile).join(" · ") || "—" : "—"}
            </p>
          </div>
          <div>
