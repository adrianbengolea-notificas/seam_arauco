...
export function ClienteDashboardClient() {
  ...
  const { ots, loading: otsLoading } = useWorkOrdersByEspecialidad(undefined, "ALL", "ALL", {
    uid: user?.uid ?? "",
    ...
    <div className="space-y-8 pb-16">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Seguimiento SEAM · <span className="font-medium text-foreground">Todas las plantas</span>{" "}
          <span className="text-muted-foreground">(vista consolidada)</span>
        </p>
      </header>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription>Por subtipo (todas las plantas)</CardDescription>
          </CardHeader>
          <CardContent className="text-2xl font-semibold tabular-nums">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Top 5 por cantidad de OTs en el conjunto cargado</CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">
            {!activosTop.length ? (
              ...
              activosTop.map((a) => (
                ...
                >
                  ...
                  <span className="text-xs text-muted-foreground">{a.n} órdenes</span>
                </Link>
              ))
            )}
          </CardContent>
