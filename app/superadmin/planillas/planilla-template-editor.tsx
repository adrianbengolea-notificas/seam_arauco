    ...
    <Card className="border-brand/40 shadow-md">
      <CardHeader className="space-y-1 border-b border-zinc-100 pb-4 dark:border-zinc-800">
        <div className="flex flex-wrap items-start justify-between gap-2">
          <div>
            ...
            <CardDescription>
              Documento <span className="font-mono">{draft.id}</span> · Cambiar IDs de secciones o ítems puede afectar
              OTs en curso.
            </CardDescription>
          </div>
      ...
      <CardContent className="space-y-6 pt-6">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-zinc-800 dark:text-zinc-200">Subtipo de OT</label>
            <select
              className={selectClass}
              value={draft.subTipo}
              onChange={(e) =>
