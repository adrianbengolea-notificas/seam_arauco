  ...
  return (
    <View style={s.wrap}>
      ...
      <View style={{ flexDirection: "row", marginTop: 16 }}>
        <View style={[s.sigBox, { flex: 1, marginRight: 6 }]}>
          <Text style={{ fontSize: 8, fontWeight: "bold", marginBottom: 4 }}>Nombre y firma por Arauco</Text>
        ...
        <View style={[s.sigBox, { flex: 1, marginLeft: 6 }]}>
          <Text style={{ fontSize: 8, fontWeight: "bold", marginBottom: 4 }}>Firma técnico SEAM</Text>
          {planillaFirmaResponsableSrc(respuesta) ? (
            <Image src={planillaFirmaResponsableSrc(respuesta)!} style={s.sigImg} />
          ) : null}
