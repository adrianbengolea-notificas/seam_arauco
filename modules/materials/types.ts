...
export type MaterialesOTFilters = {
  ...
  /** A = AA, E = ELECTRICO, GG, HG (valores en Firestore en `ot_especialidad`). */
  especialidad?: "A" | "E" | "GG" | "HG" | "todos";
...
export type StockMovimiento = {
  ...
  cantidad: number;
  unidad: string;
  /** Origen del material; valor almacenado `OT` = consumo registrado desde una OT (código histórico en datos). */
